...
AWS service for hosting a virtual machine is the Elastic Compute Cloud (EC2). I am going to create an EC2 instance to host our VM which will run Ubuntu (Linux 
Distribution).
